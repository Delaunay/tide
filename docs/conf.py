...
# -*- coding: utf-8 -*-
"""
Tide documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, '..', 'tide'))
...
project = u'Tide'
_full_version = tide.__version__
author = tide.__author__
copyright = tide.__copyright__
...
latex_documents = [
    (master_doc, 'tide.tex', u'Tide Documentation',
     u'authors', 'manual'),
]
...
man_pages = [
    (master_doc, 'tide', 'Tide Documentation',
     [author], 1)
]
